...
def create_action(p):
    ...
    if a1 == 0:
        u = [0,1,0,1] # TURN_LEFT and MOVE_FORWARD
    elif a1 == 1:
        u = [0,0,1,1] # TURN_RIGHT and MOVE_FORWARD
    elif a1 == 2:
        u = [0,1,0,0] # TURN_LEFT
    elif a1 == 3:
        u = [0,0,1,0] # TURN_RIGHT
    elif a1 == 4:
        u = [0,0,0,1] # MOVE_FORWARD
    else:
        u = [0,0,0,0] # NOP
...
def extend_action(game, u):
    ...
    # BFG expends 40 energy cell units per shot.
    ...
    choose_weapon = [0]*7 # SELECT_WEAPON1..SELECT_WEAPON7
    
    if selected_weapon != best_weapon:
        choose_weapon[best_weapon-1] = 1
    
    u.extend(choose_weapon)
    return u
...
l_gru, _output_step = create_network(12, 'policy_final_track2.pkl')
...
while not game.is_episode_finished():
    ...
    u_lst = extend_action(game, u_lst)
